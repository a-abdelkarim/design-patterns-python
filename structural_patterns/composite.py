...
if __name__ == '__main__':
    sub1 = Composite("submenu1") # Build a composite submenu 1
    ...
    top = Composite("top_menu") # Build a top-level composite menu

    sub2 = Child("submenu2") # Build a submenu 2 that is not a composite
