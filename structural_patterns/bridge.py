...
if __name__ == '__main__':
    circle1 = Circle(1, 2, 3, DrawingAPIOne()) # Build the first Circle object using API One
    circle1.draw() # Draw a circle

    circle2 = Circle(2, 3, 4, DrawingAPITwo()) # Build the second Circle object using API Two
